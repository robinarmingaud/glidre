...
from gliner.utils import is_module_available, MissedPackageException
...
class Encoder(nn.Module):
    ...
    def encode_text(self, input_ids, attention_mask, *args, **kwargs):
        token_embeddings, attentions = self.bert_layer(input_ids, attention_mask, *args, **kwargs)
...
class BiEncoder(Encoder):
    ...
    def forward(self, input_ids, attention_mask, 
        ...
        token_embeddings, attentions = self.encode_text(input_ids, attention_mask, *args, **kwargs)

        labels_embeddings = self.encode_labels(labels_input_ids, labels_attention_mask, *args, **kwargs)
        return token_embeddings, attentions, labels_embeddings
